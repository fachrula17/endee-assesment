...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('order.store') }}" method="POST" id="client_form" data-parsley-validate>
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" name="item_price" id="item_price" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label for="order_date">Order Date</label>
                        <input type="date" name="order_date" class="form-control" id="order_date" placeholder="YYYY/MM/DD" required>
                    </div>
                    <div class="form-group">
